...
from api_property.mixins import LastSearchESRecommendationMixin, ElasticSearchMixin
from api_property.serializers import LastSearchPropClassSerializer, PropClassSerializer


class DontMissProps(ElasticSearchMixin, APIView):
    ...
    def get_es_body(self, *args, **kwargs):
        return {
            ...
            "sort": [{"scoring": "desc"}, {"list_date": {"order": "desc"}}],
        }
    ...
    def post(self, request, *args, **kwargs):
        ...
        if response_ := response.get("hits", {}).get("hits"):
            ...
            data = {"server message": "there is not don't_miss_properties for this user"}
...
class LastSearchDontMissProps(LastSearchESRecommendationMixin, DontMissProps):
