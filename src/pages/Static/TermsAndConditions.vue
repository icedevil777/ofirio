<template>
  <div class="page-header">
    <span class="heading">Terms of Use</span>
  </div>
  <ol class="text-block wrapper">
    <span class="list-heading">Effective Date: {{ effectiveDate }}</span>
    <p class="text">
    ...
    <p class="text">
      Our Privacy Policy, available at www.ofirio.com, is incorporated by reference into these Terms. Please read these Terms and the Privacy Policy carefully before you access the Services, as these Terms form a binding legal agreement between you and Ofirio.
    </p>
    <p class="text">
    ...
    <li>
      <span class="list-heading">Overview of Services; Disclaimer.</span>
      <ol class="sub-list">
        <li>
          <span class="sub-list-heading">Overview  of  Services.</span>
          <span class="text">
            Ofirio is a real estate data provider of in-depth information on any US property, commercial or residential. The specific features and functionality of our Services are dynamic and may change from time to time.
          </span>
        </li>
        <li>
          <span class="sub-list-heading">Disclaimer.</span>
          <span class="text">
    ...
    <li>
      <span class="list-heading">Your Eligibility; Your Responsibility</span>
      <p class="text">
    ...
    <li>
      <span class="list-heading">Personal Information; Your Content; Your Account</span>
      <ol class="sub-list">
        <li>
          <span class="sub-list-heading">Accuracy.</span>
          <span class="text">
        ...
        <li>
          <span class="sub-list-heading">Privacy.</span>
          <span class="text">
            To use our Services, you must register with us and submit certain personally identifiable information. You expressly agree that we may collect, disclose, store and otherwise use your information in accordance with the terms of the Ofirio Privacy Policy, available at <router-link :to="{ name: 'static-privacy-policy'}" class="ui-href ui-href-underline">Privacy Policy</router-link>.
          </span>
        </li>
        <li>
          <span class="sub-list-heading">Your Content.</span>
          <span class="text">
            As between you and Ofirio, you own the information, materials, photos, or other content (the “Content”) you provide Ofirio under this Agreement. Any Content that you upload or otherwise provide to Ofirio in connection with the Services may be used by Ofirio in order to provide and promote the Services or Ofirio’s business. Accordingly, you grant to Ofirio, and all of its subsidiaries, affiliates, successors, and assigns, a worldwide, perpetual, irrevocable, royalty-free, fully paid, sublicensable, non-exclusive, and transferable right to use, publish, reproduce, distribute, modify, prepare derivative works of, adapt, publicly display and otherwise use the Content. Such right to use such Content shall survive the termination of these Terms and termination of the Services. You authorize us to use, forward, or post your profile or related information on other sites and services. Additionally, you authorize us to use your corporate logo and corporate name, if applicable, for any promotional purposes (to opt-out, email us at <a href="mailto:help@ofirio.com" class="ui-href ui-href-underline">help@ofirio.com</a>). Notwithstanding the foregoing, you retain all rights to the Content, except as otherwise provided herein or as otherwise provided in any other agreement between you and Ofirio. Any Content you submit to us is provided at your own risk of loss. You are solely responsible for all Content you share, provide, display, publish, or disseminate to others, whether such action was taken by us or you. By providing Content to us, you represent and warrant that you are entitled to submit it and that it is not confidential and not in violation of any law, contractual restrictions or other third party rights (including any intellectual property rights). Ofirio may also remove or delete your Content from the Services at any time in its sole discretion.
          </span>
        </li>
        <li>
          <span class="sub-list-heading">Other Users.</span>
          <span class="text">
            You acknowledge and agree that we do not have an obligation to verify any Content or other information provided by users on the Services. Ofirio also enables sharing of information by allowing users to post content and information, including links and other information. Pursuant to the license granted by you above, Ofirio may grant other users of the Services access and share rights to your Content in accordance with these Terms, your settings and the nature of your connection with such other users. Information you share may be seen and used by other users of the Services. Ofirio cannot guarantee that users of the Services will not use the information that you share on Ofirio, nor the manner of use. Ofirio is not responsible for another user’s or other third party’s misappropriation or misuse of your Content or other information. Additionally, Ofirio is not responsible for the truthfulness, accuracy, authenticity, or completeness of any of the Content or any other information provided by other users or any other third party. You hereby release Ofirio from all claims, demands, or damages of every kind, known or unknown, in any way connected with (i) any relationship arising between users of the Services, (ii) any dispute between you and another user, or (iii) arising out of any services which originated through the Services or were otherwise provided by a user. Additionally, you agree to immediately report to us any false information provided or misconduct by any user of the Services.
          </span>
        </li>
        <li>
          <span class="sub-list-heading">Social Media Integration.</span>
          <span class="text">
            The Services may allow you to enable or log in to the Services via various social networking services like Facebook or Twitter (“Social Network Service(s)”). By directly integrating these services, we make your online experiences richer and more personalized. To take advantage of this feature, we will ask you to log into or grant us permission via the relevant Social Network Service. When you add a Social Network Services account to the Service or log into the Service using your Social Network Services account, we will collect relevant information necessary to enable the Service to access that Social Network Service and your data contained within that Social Network Service. As part of such integration, the Social Network Service will provide us with access to certain information that you have provided to the Social Network Service, and we will use, store and disclose such information in accordance with our privacy statement. However, please remember that the manner in which Social Network Services use, store and disclose your information is governed by the policies of such third parties, and Ofirio shall have no liability or responsibility for the privacy practices or other actions of any Social Network Services that may be enabled within the Service. 
          </span>
        </li>
        <li>
          <span class="sub-list-heading">Your Account.</span>
          <span class="text">
        ...
        <li>
          <span class="sub-list-heading">Feedback.</span>
          <span class="text">
            You may from time to time identify problems, solutions to identified problems, provide suggestions, comments or other feedback related to our Services or otherwise relating to Ofirio (“Feedback”) to Ofirio. You acknowledge and agree that all Feedback is and shall be given entirely voluntarily and Ofirio shall be free to use or disclose such Feedback for any purpose. You further acknowledge and agree that your Feedback does not contain confidential or proprietary information and you are not entitled to any compensation or reimbursement of any kind from Ofirio under any circumstances relating to such Feedback.
          </span>
        </li>
      </ol>
    </li>
    <li>
      <span class="list-heading">Personal Use; Limited License; Ownership</span>
      <p class="text">
    ...
    <li>
      <span class="list-heading">Fees; Payment Terms; Credits</span>
      <p class="text">
      ...
      <p class="text">
        Failure to pay may result in the termination of your subscription. You may cancel or suspend your Paid Services by contacting Ofirio at <a href="mailto:help@ofirio.com" class="ui-href ui-href-underline">help@ofirio.com</a>. Unless expressly stated to the contrary, we do not guarantee refunds for lack of usage, dissatisfaction or any other reason.
      </p>
      <p class="text">
    ...
    <li>
      <span class="list-heading">Acceptable Use Policy</span>
      <p class="text">
        ...
        <ul>
          ...
          <li>The transmission or posting of chain letters or pyramid schemes, or other acts that involve deceptive online marketing practices or fraud;</li>
          <li>Acts that may materially and adversely affect the quality of other users’ experience;</li>
          <li>Actual or attempted unauthorized use or sabotage of any computers, machines or networks;</li>
          <li>Introducing malicious programs into Ofirio’s Services, network or servers (e.g. viruses, worms, Trojan horses, etc.);</li>
          <li>Engaging in any monitoring or interception of data not intended for you without authorization;</li>
          <li>Attempting to circumvent authentication or security of any host, network, or account without authorization;</li>
          ...
          <li>Adapt, modify or create derivative works based on the Services, technology underlying the Services, or other users’ content, in whole or part;</li>
          <li>Duplicate, license, sublicense, publish, broadcast, transmit, distribute, perform, display, sell, rebrand, or otherwise transfer information found on the Services (excluding content posted by you) except as permitted in these Terms, or as expressly authorized by Ofirio in writing;</li>
          <li>Using any method, software or program designed to collect identity information, authentication credentials, or other information;</li>
          <li>Transmitting or receiving, uploading, using or reusing material that is abusive, indecent, defamatory, harassing, obscene or menacing, or a breach of confidence, privacy or similar third party rights;</li>
          <li>Transmitting or receiving, uploading, using or reusing material that violates any intellectual property rights of a third party, including, without limitation, patents, trademarks, trade secrets or copyrights;</li>
          <li>Transmitting, receiving, uploading, using or reusing material that you do not have a right to transmit under any law or under contractual or fiduciary relationships (such as inside information, proprietary and confidential information learned or disclosed as part of employment relationships or under nondisclosure agreements);</li>
          <li>Falsifying user identification information;</li>
          <li>Using the Services for anything other than lawful purposes including, but not limited to, intentionally or unintentionally violating any applicable local, state, national or international law;</li>
          or
          <li>Impersonating any person or entity, including, but not limited to, an Ofirio representative, or falsely stating or otherwise misrepresenting your affiliation with a person or entity.</li>
        </ul>
      </p>
      <p class="text">
        ...
        <ul>
          <li>Bulk unsolicited e-mail, promotional material, or other forms of solicitation sent via the Services, or e-mail that advertises any IP address belonging to Ofirio or any URL (domain) that is hosted by Ofirio.</li>
          <li>The use of web pages set up on ISPs that allow SPAM-ing that directly or indirectly reference customers to domains or IP addresses hosted by Ofirio.</li>
    ...
    <li>
      <span class="list-heading">Copyright Protected Materials</span>
      <p class="text">
      ...
      <p class="text">
        If you believe in good faith that your copyright has been infringed, please provide a written communication regarding such belief to: <a href="mailto:help@ofirio.com" class="ui-href ui-href-underline">help@ofirio.com</a>
      </p>
    </li>
    <li>
      <span class="list-heading">Right to Restrict or Terminate Access</span>
      <p class="text">
    ...
    <li>
      <span class="list-heading">Security</span>
      <p class="text">
    ...
    <li>
      <span class="list-heading">Virtual Office Website and Internet Data Exchange</span>
      <p class="text">
        ...
        <ol class="sub-list">
          <li>
            <span class="sub-list-heading">Non-Commercial Use.</span>
            <span class="text">
              You acknowledge and understand that the Terms of Use creates a customer relationship with Ofirio. This does not impose a financial obligation on you or create any representation agreement between you and Ofirio. If you have an exclusive representation agreement with any other real estate agent or broker, that agreement may prohibit you from receiving the type of real estate services that Ofirio may provide unless you first obtain that agent or broker's permission. By accepting this Terms of Use, you warrant and affirm that you are not in an exclusive representation agreement with another real estate agent or broker that prevents you from now agreeing to receive service from Ofirio or an Ofirio broker through our website.
            </span>
          </li>
          <li>
            <span class="sub-list-heading">Non-Commercial Use.</span>
            <span class="text">
              You understand that all data obtained from the VOW and/or IDX is intended only for your personal, non-commercial use.
            </span>
          </li>
          <li>
            <span class="sub-list-heading">Bona Fide Interest.</span>
            <span class="text">
              You have a bona fide interest in the purchase, sale, or lease of real estate of the type being offered through the VOW and/or IDX.
            </span>
          </li>
          <li>
            <span class="sub-list-heading">No Distribution.</span>
            <span class="text">
              You agree not to copy, redistribute or retransmit any of the data or information provided from the MLS® database;
            </span>
          </li>
          <li>
            <span class="sub-list-heading">Copyright.</span>
            <span class="text">
              You acknowledge the Board/Association ownership of and the validity of the copyright in the MLS® database.
            </span>
          </li>
          <li>
            <span class="sub-list-heading">Disclosure to Board.</span>
            <span class="text">
              You agree that all information you provided to Ofirio may be provided to the relevant Board and may be used to administer and operate the VOW and/or IDX and to investigate any breach of security of the data or the MLS® rules
            </span>
          </li>
          <li>
            <span class="sub-list-heading">Acknowledgement.</span>
            <span class="text">
              You agree that creating an account is sufficient acknowledgement and agreement to the Terms of Use and would like access to the VOW and/or IDX information upon account creation.
            </span>
          </li>
          <li>
            <span class="sub-list-heading">Username and Password.</span>
            <span class="text">
              You must supply a user name and a password, the combination of which must be different from those of all other Registrants on the VOW or IDX, before being permitted to search and view information from the MLS® database via the VOW and/or IDX.
            </span>
          </li>
          <li>
            <span class="sub-list-heading">Email Address.</span>
            <span class="text">
              You must provide a valid email address. The Registrant may be permitted to access the VOW and/or IDX only after Ofirio has verified that the email address provided is valid and the Registrant's agreement to the VOW's and/or IDC’s Terms of Use is confirmed.
            </span>
          </li>
          <li>
            <span class="sub-list-heading">Retention by Ofirio.</span>
            <span class="text">
              You understand that Ofirio must at all times maintain a record of the name, telephone number and email address supplied by you, the Registrant, and the username and current password of each Registrant. Such records are to be kept for not less than 180 days after the expiration of the validity of the Registrant's password. If the Board/Association has reason to believe that a Participant's VOW and/or IDX has caused or permitted a breach in the security of the data or a violation of MLS® rules related to use by one or more Registrants, the Participant shall, upon request, provide to the Board/Association a copy of the record of the name, email address, telephone number, username, current password, and audit trail, if required, of any Registrant identified by the Board/Association to be suspected of involvement in the violation.
            </span>
          </li>
          <li>
            <span class="sub-list-heading">No Warranty.</span>
            <span class="text">
              You understand that information on this site is deemed to be valid but is not guaranteed. It is the responsibility of the Registrants to confirm all information on their own. Ofirio may not have reviewed or approved listing enhancements. All information provided by the listing agent/broker is deemed reliable but is not guaranteed and should be independently verified.
            </span>
          </li>
          <li>
            <span class="sub-list-heading">No Further Agreement.</span>
            <span class="text">
              You understand any agreement entered into at any time between the Participant and Registrant imposing a financial obligation on the Registrant or creating agency representation of the Registrant by the Participant must be established separately from the Terms of Use, must be prominently labelled and may not be accepted solely by “mouse click”.
            </span>
          </li>
        </ol>
      </p>
    ...
    <li>
      <span class="list-heading">Investment Disclaimer</span>
      <p class="text">
    ...
    <li>
      <span class="list-heading">Disclaimer of Warranty</span>
      <p class="text">
    ...
    <li>
      <span class="list-heading">Limitation of Liability</span>
      <p class="text">
    ...
    <li>
      <span class="list-heading">Indemnity</span>
      <p class="text">
    ...
    <li>
      <span class="list-heading">Dispute Resolution</span>
      <p class="text">
    ...
    <li>
      <span class="list-heading">Electronic Notices and Disclosures</span>
      <p class="text">
    ...
    <li>
      <span class="list-heading">Changes to the Terms</span>
      <p class="text">
    ...
    <li>
      <span class="list-heading">Third-Party Terms &amp; Content</span>
      <p class="text">
...
import TermsOfUseModel from '@/models/OFRC/TermsOfUse';
...
export default defineComponent({
  ...
  computed: {
    effectiveDate() {
      return envModel.VUE_APP_TERMS_UPDATE_DATE;
    }
  },
  mounted() {
    TermsOfUseModel.getMlsInfo().then((result) => {
      this.mlsDates = result;
    })
  }
})
</script>
...
<style lang="less" scoped>
  ...
  .sub-list {
    li {
      text-indent: 30px;
      &:before { font-weight: initial }
    }
    .sub-list-heading { text-decoration: underline }
    &.reset-counter {
      counter-reset: list-reset;

      > li {
        counter-increment: list-reset;
        &::before { content: counters(list-reset, "") "."; }
      }
    }
  }
